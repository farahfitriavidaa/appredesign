    <head>
        ...
        <title>UMKM <?=$this->session->nama_umkm?> - gDESK</title>
        <meta content="gDESK - Dashboard untuk UMKM yang melakukan re-design kemasan" name="description" />
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        ...
        <link rel="stylesheet" href="<?=base_url()?>asset/admin/css/icons.css" type="text/css">
        <link rel="stylesheet" href="<?=base_url()?>asset/admin/css/style.css" type="text/css">
