                    ...
                    <div class="page-content-wrapper ">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row mb-3" style="justify-content: flex-end;">
                                <div>
                                    <a class="btn btn-secondary btn-sm <?=$filter==="semua"?"btn-outline-secondary":"border-0"?>" href="<?=base_url();?>admin/Diskusi/lihatDiskum/semua">
                                        Semua diskusi
                                    </a>
                                </div>
                                <div>
                                    <a class="btn btn-secondary btn-sm <?=$filter==="belum-selesai"?"btn-outline-secondary":"border-0"?>" href="<?=base_url();?>admin/Diskusi/lihatDiskum/">
                                        Belum selesai
                                    </a>
                                </div>
                                <div>
                                    <a class="btn btn-secondary btn-sm <?=$filter==="telah-selesai"?"btn-outline-secondary":"border-0"?>" href="<?=base_url();?>admin/Diskusi/lihatDiskum/telah-selesai">
                                        Telah selesai
                                    </a>
                                </div>
                            </div>
                            ...
                            <?php foreach($daftar_diskusi as $diskusi): ?>
                                <a href="<?=base_url();?>admin/Diskusi/diskum/<?=$diskusi->IDPesan?>" target="_blank" class="list-diskusi mb-2" noopener noreferer>
                                    <div class="card">
                                        <div class="card-body">
