          ...
          <div class="modal-dialog" role="document">
           ...
           <div class="modal-body">
             ...
             <?php }else if($key->Logo_produk){ ?>
              <img src="<?=base_url()?>uploads/logo_produk/<?=$key->Logo_produk?>" width="450px" alt="Design"><br>
          ...
          <div class="modal-dialog" role="document">
           ...
           <div class="modal-body">
             ...
             <?php }else if($key->Kemasan_produk){ ?>
              <img src="<?=base_url()?>uploads/foto_kemasan_lama/<?=$key->Kemasan_produk?>" width="450px" alt="Design"><br>
